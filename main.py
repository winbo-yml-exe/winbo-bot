...
async def getairesponse(question):
    ...
    payload = {
        'message': question,
        'system_prompt': 'You are Winbo\'s bot. An AI based on OpenAI\'s ChatGPT 4o and make to provide users with things a normal AI would. Your knowledge goes up to August 2023. You reply in a fun, but still a little bit professional way. If the user asks for things like a Nextcord bot, assume they already have the environment set up.'
    }
    headers = {
